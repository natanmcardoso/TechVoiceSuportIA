...
API_TOKEN = os.getenv("API_TOKEN")  # Token de API do usuário, lido do .env

# =========================
# Mapeamento de Categorias do GLPI
# =========================
# Dicionário que relaciona intenções/frases a categorias do GLPI
CATEGORIAS = {
    "infraestrutura": {
        "category_id": 1,
    ...
    "infraestrutura backup falha de backup": {
        "category_id": 4,
        "title": "Infraestrutura > Backup > Falha de Backup"
    },
...
def classify_intent(texto):
    ...
    """
    texto = texto.lower()
    # Priorizar categorias de nível mais profundo (nível 4 > nível 3 > nível 2 > nível 1)
